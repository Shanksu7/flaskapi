...
if [[ -z "$ss_output" ]]; then
    ...
    GUNICORN_CMD_ARGS="--timeout 600 --access-logfile '-' --error-logfile '-' -c /opt/startup/gunicorn.conf.py --chdir=/home/site/wwwroot" uvicorn app:app --host 0.0.0.0 --port 8000
else
